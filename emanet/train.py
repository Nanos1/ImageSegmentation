...
#=============================================
	...
	if not os.path.exists('/work2/pa21/ptzouv/gnanos/images_256/monitor_val_loss/emanet/best_model'):
		os.makedirs('/work2/pa21/ptzouv/gnanos/images_256/monitor_val_loss/emanet/best_model')

	if not os.path.exists('/work2/pa21/ptzouv/gnanos/images_256/monitor_val_loss/emanet/model_save'):
		os.makedirs('/work2/pa21/ptzouv/gnanos/images_256/monitor_val_loss/emanet/model_save')
	filepath="/work2/pa21/ptzouv/gnanos/images_256/monitor_val_loss/emanet/model_save/weights-{epoch:04d}.hdf5"
	...
	log_dir = os.path.join("/work2/pa21/ptzouv/gnanos/images_256/monitor_val_loss/emanet/model", datetime.datetime.now().strftime("%Y%m%d-%H%M%S"))
...
#============================================
	...
	print('-'*20, 'Finish Training', '-'*20)
        ...
        # Best model    
	model = tf.keras.models.load_model('/work2/pa21/ptzouv/gnanos/images_256/monitor_val_loss/emanet/model_save/' + sorted(os.listdir('/work2/pa21/ptzouv/gnanos/images_256/monitor_val_loss/emanet/model_save'))[-1], custom_objects={"iou_loss": iou_loss, "recall2": recall2, "recall3": recall3, "precision2": precision2,"precision3": precision3, "dice_loss": dice_loss, "dice_loss2": dice_loss2})
        # save model
	model.save("/work2/pa21/ptzouv/gnanos/images_256/monitor_val_loss/emanet/best_model/emanet.h5")

	model.save_weights('/work2/pa21/ptzouv/gnanos/images_256/monitor_val_loss/emanet/weights')
	print('Epochs run: ', len(history.history['loss']))

model_save_dir = '/work2/pa21/ptzouv/gnanos/images_256/monitor_val_loss/emanet/best_model'
