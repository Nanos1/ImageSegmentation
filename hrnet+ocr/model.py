...
def hrnet_v2(x, n_class = 1, include_top = True, n_channel = 48, n_module = [1, 4, 3], n_branch = [2, 3, 4], stage1_channel = 64, stage1_module = 1, ocr_feature_channel = 512, ocr_attention_channel = 256, ocr_dropout_rate = 0.05, ocr_scale = 1, mode = "ocr", **kwargs):
...
def hrnet18_v2(x, n_class = 1, include_top = True, mode = "ocr"):
...
def hrnet32_v2(x, n_class = 1, include_top = True, mode = "ocr"):
...
def hrnet48_v2(x, n_class = 1, include_top = True, mode = "ocr"):
